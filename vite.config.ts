  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        hub_providerDeployerAiAct: resolve(import.meta.dirname, 'provider-deployer-ai-act/index.html'),
        hub_aiActPubblicaAmministrazione: resolve(import.meta.dirname, 'ai-act-pubblica-amministrazione/index.html'),
        hub_aiActPerLeAziende: resolve(import.meta.dirname, 'ai-act-per-le-aziende/index.html'),
        hub_sanzioniAiAct: resolve(import.meta.dirname, 'sanzioni-ai-act/index.html'),
        hub_aiActEGdpr: resolve(import.meta.dirname, 'ai-act-e-gdpr/index.html'),
        hub_friaAiAct: resolve(import.meta.dirname, 'fria-ai-act-valutazione-diritti-fondamentali/index.html'),
        ...
        hubEn_providerDeployerAiAct: resolve(import.meta.dirname, 'en/provider-deployer-ai-act/index.html'),
        hubEn_aiActPublicAdministration: resolve(import.meta.dirname, 'en/ai-act-public-administration/index.html'),
        hubEn_aiActForBusiness: resolve(import.meta.dirname, 'en/ai-act-for-business/index.html'),
        hubEn_aiActPenalties: resolve(import.meta.dirname, 'en/ai-act-penalties/index.html'),
        hubEn_aiActAndGdpr: resolve(import.meta.dirname, 'en/ai-act-and-gdpr/index.html'),
        hubEn_friaAiAct: resolve(import.meta.dirname, 'en/fria-ai-act-fundamental-rights-impact-assessment/index.html'),
