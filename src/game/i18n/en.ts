...
export const en: Locale = {
  ui: {
    ...
    inspectorDesk: {
      evidencePhase: 'INSPECTOR DESK · EXHIBIT REVIEW',
      decisionPhase: 'INSPECTOR DESK · DRAFTING THE ACT',
      fileLabel: 'CASE FILE {code}',
      evidenceStatus: 'OPENED {opened}/{total} · CITED {cited}',
      citedStatus: 'CITED EVIDENCE {cited}',
      context: 'CASE FILE',
      compare: 'COMPARE [X]',
      norm: 'RULE',
      normLocked: 'RULE IN DECISION',
      archive: 'ARCHIVE',
      notebook: 'NOTEBOOK',
      terms: 'TERMS',
      compareTitle: 'COMPARE EXHIBITS',
      compareIntro: 'Two documents on the same desk: compare provenance, function and content before deciding.',
      compareCounter: 'PAIR {current} OF {total}',
      compareSource: 'SOURCE',
      compareFunction: 'FUNCTION',
      compareUnknownSource: 'not stated',
      compareUnknownFunction: 'to assess',
      compareHint: 'Look for what corroborates, what conflicts and which source can better support the report.',
      comparePrev: 'PREVIOUS PAIR',
      compareNext: 'NEXT PAIR',
      compareCloseEvidence: 'Back to exhibits',
      compareCloseDecision: 'Back to decision',
      compareEmpty: 'Cite at least two exhibits before comparing them.'
    },
    caseNorm: {
      button: 'CASE RULE',
    ...
    debrief: {
      ...
      noError: 'no finding',
      anatomyLabel: 'Case anatomy',
      anatomySignal: 'decisive signal',
      anatomyTrap: 'minimizing trap',
      anatomyTrapNone: 'no minimizing exhibit in this file',
