...
export const it = {
  ui: {
    ...
    inspectorDesk: {
      evidencePhase: 'POSTAZIONE ISPETTIVA · ESAME REPERTI',
      decisionPhase: 'POSTAZIONE ISPETTIVA · REDAZIONE ATTO',
      fileLabel: 'FASCICOLO {code}',
      evidenceStatus: 'APERTI {opened}/{total} · CITATI {cited}',
      citedStatus: 'PROVE CITATE {cited}',
      context: 'FASCICOLO',
      compare: 'CONFRONTA [X]',
      norm: 'NORMA',
      normLocked: 'NORMA IN DECISIONE',
      archive: 'ARCHIVIO',
      notebook: 'TACCUINO',
      terms: 'TERMINI',
      compareTitle: 'CONFRONTO REPERTI',
      compareIntro: 'Due documenti sullo stesso piano: confronta provenienza, funzione e contenuto prima di decidere.',
      compareCounter: 'COPPIA {current} DI {total}',
      compareSource: 'FONTE',
      compareFunction: 'FUNZIONE',
      compareUnknownSource: 'non dichiarata',
      compareUnknownFunction: 'da valutare',
      compareHint: 'Cerca ciò che si conferma, ciò che si smentisce e quale fonte regge meglio il rapporto.',
      comparePrev: 'COPPIA PRECEDENTE',
      compareNext: 'COPPIA SUCCESSIVA',
      compareCloseEvidence: 'Torna ai reperti',
      compareCloseDecision: 'Torna alla decisione',
      compareEmpty: 'Cita almeno due reperti prima di confrontarli.'
    },
    caseNorm: {
    ...
    debrief: {
      ...
      anatomyLabel: 'Anatomia del caso',
      anatomySignal: 'segnale decisivo',
      anatomyTrap: 'trappola minimizzante',
      anatomyTrapNone: 'nessun reperto minimizzante in questo fascicolo',
